            ...
            <Link to={`/learning-paths/${path.id}`}>
              <Card className="hover-glow hover:border-primary/30 transition-all group h-full">
                <CardContent className="p-6">
                  <div className="h-12 w-12 rounded-xl gradient-bg flex items-center justify-center text-white mb-4"><TrendingUp className="h-6 w-6" /></div>
                  ...
                  <Button variant="link" className="mt-3 p-0 h-auto text-primary">Start this path <ArrowRight className="ml-1 h-4 w-4" /></Button>
                </CardContent>
              </Card>
            </Link>
          </motion.div>
